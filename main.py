    ...
    if args.action == "train":
        if args.model == "Densenet121":
            train_model_with_dataset(data_path="data/annotations/train.csv",
                                    ...
                                    device_ids=[0, 1, 3],
                                    epochs=args.epoch, learning_rate=0.005,
            ...
            train_model_with_dataset(data_path="data/annotations/train.csv",
                                    ...
                                    batch_size=6, num_workers=16, device=args.device,
                                    device_ids=[0, 1, 3],
                                    epochs=args.epoch, learning_rate=0.001,
        ...
        inference_model(data_path="data/annotations/test.csv",
                        image_dir="data/test_images",
        ...
        evaluate_model_with_dataset(data_path="data/annotations/test.csv",
                                    ...
                                    model_type=args.model,
                                    model_path=args.model_path,
                                    batch_size=1, num_workers=4, device=args.device)  
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='FasterRCNN', choices=['FasterRCNN', 'RetinaNet', 'Densenet121', 'Densenet169', 'Densenet201', 'Ensemble'])
